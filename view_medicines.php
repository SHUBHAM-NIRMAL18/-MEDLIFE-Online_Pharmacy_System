...
<?php 
  ...
  try{
    ...
    $sql = "SELECT * FROM tbl_products where cat_id = 1";
...
<body>
  <div class="container">
  <h2 style="margin-top:80px; margin-left:800px;"><u>View Medicines</u></h2>
  
  <a class = 'button1' href='products.php'>Add Medicines</a>
    <table border=1>
      <tr>
        <th>SN</th>
      ...
      <?php for($i=0;$i< count($categories);$i++) { ?>
        <tr>
          ...
          <td>
            ...
            <a class='buttom' href="delete_products.php?cat_id=<?php echo $categories[$i]['cat_id'] ?>" onclick="return confirm('Are you sure?')">Delete </a>
          </td>
        </tr>
        <?php } ?>
    </table>
