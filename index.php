...
<?php
    ...
    $sql = 'select * from tbl_products where cat_id=1 limit 5';
...
$sql = 'select * from tbl_products where cat_id=3 limit 5';
...
$sql = 'select * from tbl_products where cat_id=2 limit 5';
...
<body>
  ...
  <div class="header">
    <div class="logo">
      <img src="logo/MEDLOGO.png" alt="Logo">
    </div>
    <div class="nav">
      <div class="nav-item"><a href="#" style="color:black ; text-decoration:none">HOME</a></div>
      ...
      <div class="nav-item"><a href="u_devices.php"style="color:black ; text-decoration:none">CATEGORIES</a></div>
      <div class="nav-item">
      <?php 
      if(!isset($_SESSION['email']))
      { 
  ...
  <div class="image-container">
    <div class="image">
      <img src="img/image 6.jpg" alt="Image 1">
      <div class="quote1">10% discount</div>
    </div>
    <div class="image">
      <img src="img/image 8.jpg" alt="Image 2">
      <div class="quote1">Cash On Delivary</div>
    </div>
    <div class="image">
      <img src="img/image 9.jpg" alt="Image 3">
      <div class="quote1">East Return</div>
    </div>
  </div>
            ...
            <h2><u>Supplements</u></h2>
            <?php while($roww = mysqli_fetch_assoc($supplements)){ ?>
            <div class="product-card">
                    <img src="<?php echo "medimg/".$roww['prdct_img'];?>" style="width:100px ; height:80px" alt="Product Image">
                    <p><?php echo $roww['prdct_name'];?></p>
                    <p class="price"><?php echo "Rs".$roww['prdct_price'];?></p>
                    <button class="btn-buy-now"><a href='single.php?id=<?php echo $roww['prdct_id']; ?>' style="color:white ; text-decoration:none">Details</a></button>
                    <button class="btn-add-to-cart"><a href='addToCart.php?id=<?php echo $roww['prdct_id']; ?>' style="color:black ; text-decoration:none">Add to Cart</a></button>
            </div>
            <?php } ?>

        <h2><u>Devices</u></h2>
        <?php while($rowww = mysqli_fetch_assoc($devices)){ ?>
        <div class="product-card">
                    <img src="<?php echo "medimg/".$rowww['prdct_img'];?>" style="width:100px ; height:80px" alt="Product Image">
                    <p><?php echo $rowww['prdct_name'];?></p>
                    <p class="price"><?php echo "Rs".$rowww['prdct_price'];?></p>
                    <button class="btn-buy-now"><a href='single.php?id=<?php echo $rowww['prdct_id']; ?>' style="color:white ; text-decoration:none">Details</a></button>
                    <button class="btn-add-to-cart"><a href='addToCart.php?id=<?php echo $rowww['prdct_id']; ?>' style="color:black ; text-decoration:none">Add to Cart</a></button>
        </div>
        <?php } ?><hr><br><br>
        <h3 style="text-align:center;color:black">Customer Review</h3>
                <div class="slider">
            <div class="slider-container">
            <div class="review-card">
                <img src="img/vasline.jpg" alt="Customer 1">
                <h3>Ajit</h3>
                <p>Nulla facilisi. Sed vestibulum risus eu eros lobortis, vitae vulputate leo feugiat.</p>
            </div>
            <div class="review-card">
                <img src="img/vasline.jpg" alt="Customer 2">
                <h3>Ram</h3>
                <p>Nulla facilisi. Sed vestibulum risus eu eros lobortis, vitae vulputate leo feugiat.</p>
            </div>
            <div class="review-card">
                <img src="img/vasline.jpg" alt="Customer 3">
                <h3>Lakshman</h3>
                <p>Aliquam tempus libero sed tortor ultrices, eget faucibus lorem convallis.</p>
            </div>
            <div class="review-card">
                <img src="img/vasline.jpg" alt="Customer 3">
                <h3>Nabin</h3>
